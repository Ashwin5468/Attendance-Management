  ...
  try{
    ...
    //validation of empty fields
      if(isset($_POST['signup'])){
        ...
        //insertion of data to database table ainfo
        $result = mysql_query("insert into ainfo(username,password,email,fname,phone,type) values('$_POST[uname]','$_POST[pass]','$_POST[email]','$_POST[fname]','$_POST[phone]','$_POST[type]')");
